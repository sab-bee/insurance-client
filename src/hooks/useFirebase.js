...
const useFirebase = () => {
  ...
  const [signInWithEmailAndPassword, eUser, eLoding, eError] = useSignInWithEmailAndPassword(auth)
  ...
  return {google: {handleGoogleSign, gLoading}, create: {handleCreate, cLoading}, login: {handleLogin, eLoding}}
}
