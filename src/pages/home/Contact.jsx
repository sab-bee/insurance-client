...
const ViaEmail = () => {
  return <div className='w-full md:w-4/5 lg:w-1/2 col-span-2'>
    ...
    <div class="relative">
      ...
      <input type="text" id="email-address-icon" class="bg-gray-50 text-gray-900 text-sm rounded block w-full pl-10 p-2.5 dark:bg-white outline-none " placeholder="name@someone.com" />
    </div>
    <div>
      <textarea className='w-full rounded mt-2 p-4 outline-none' name="" id="" rows="5" placeholder='write your query....'></textarea>
    </div>
    <button class="bg-gray-700 text-white px-3 h-10 md:h-9 rounded">send email</button>
  </div>
}
